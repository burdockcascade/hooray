...
namespace Hooray {
    ...
    public:
        ...
        void notify_update(float delta_time) const;
        void notify_draw() const;
    ...
    public:
        ...
        void notify_key_pressed(int key);
        void notify_mouse_pressed(int button, Vector2 pos);
        void notify_mouse_released(int button, Vector2 pos);
        void notify_mouse_moved(Vector2 pos);
